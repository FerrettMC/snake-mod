...
public class SnakeMod
{
    ...
    public static final String MOD_ID = "snakemod";
    ...
    public SnakeMod()
    {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, com.mod.snakemod.Config.SPEC);
    }
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == net.minecraft.world.item.CreativeModeTabs.REDSTONE_BLOCKS) {
            event.accept(ModItems.EYES_ITEM);
        }
    }
